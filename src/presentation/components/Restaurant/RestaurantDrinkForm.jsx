    ...
    <>
      ...
      >
        <div className="w-full">
          <div>
            <label className="block text-sm font-medium">Drink Name</label>
            <input
              type="text"
              name="name"
              value={formData.name}
          ...
          <div>
            <label className="block text-sm font-medium">Drink Price</label>
            <input
              type="text"
              name="price"
        ...
        <div>
            <label className="block text-sm font-medium">Drink Description</label>
            <textarea
              name="description"
